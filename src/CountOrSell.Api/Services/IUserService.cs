...
public interface IUserService
{
    ...
    Task UpdatePreferencesAsync(Guid userId, bool? setCompletionRegularOnly, string? defaultPage, bool? defaultAcquisitionPriceToMarket, bool? darkMode, string? navLayout = null, CancellationToken ct = default);
}
