...
public interface IUserService
{
    ...
    Task<UserServiceResult> ResetPasswordAsync(Guid targetUserId, string newPassword, CancellationToken ct = default);
    ...
    Task UpdatePreferencesAsync(Guid userId, bool? setCompletionRegularOnly, string? defaultPage, bool? defaultAcquisitionPriceToMarket, bool? darkMode, string? navLayout = null, string? cardSortDefault = null, CancellationToken ct = default);
}
